      ...
      <el-form ref="dataForm" label-position="left" label-width="220px" style="width: 100%; margin-left:50px;">
        ...
        <el-form-item label="语言">
          <el-checkbox-group v-model="checkList">
            <el-checkbox label="zh" disabled>繁体中文</el-checkbox>
            <el-checkbox label="zhCN">中文</el-checkbox>
            <el-checkbox label="en">英语</el-checkbox>
            <el-checkbox label="japan">日文</el-checkbox>
            <el-checkbox label="han">韩文</el-checkbox>
            <el-checkbox label="french">法语</el-checkbox>
            <el-checkbox label="de">德语</el-checkbox>
            <el-checkbox label="xby">西班语</el-checkbox>
            <el-checkbox label="eyu">俄语</el-checkbox> 
          </el-checkbox-group>
        </el-form-item>
    ...
    getList() {
      fetchbase_set().then(response => {
        if (response.code == 200) {
          ...
          var  language_arr=response.data.languages
          this.checkList=response.data.languages
          this.temp.languages =this.checkList
          localStorage.setItem("language",language_arr.toString())
