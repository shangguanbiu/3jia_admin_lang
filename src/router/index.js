...
export const asyncRoutes = [{
        ...
        children: [{
                ...
                name: 'adminlist',
                meta: { title: '管理员列表', icon: 'dashboard', roles: ['admin', 'yunyin'] }
            }
        ...
        children: [{
                ...
                name: 'base_set',
                meta: { title: '基础设置', icon: 'dashboard', roles: ['admin', 'yunying'] }
            },
            {
                path: 'rechargetype',
                component: () =>
                ...
                name: 'userlist',
                meta: { title: '充值通道', icon: 'dashboard', roles: ['admin', 'yunying', 'caiwu'] }
            },
            {
                path: 'message',
                component: () =>
                ...
                name: 'userlist',
                meta: { title: '公告列表', icon: 'dashboard', roles: ['admin', 'yunying','edit'] }
            },
    ...
    },
    {
        ...
        children: [{
                ...
                name: 'recharge',
                meta: { title: '充值列表', icon: 'dashboard', roles: ['admin', 'yunying', 'caiwu'] }
            }, {
                path: 'cash',
                component: () =>
    ...
    // },
    {
        ...
        children: [{
                ...
                name: 'room',
                meta: { title: '房间设置', icon: 'dashboard', roles: ['admin', 'yunying'] }
            },
            {
                path: 'zi_roomlist',
                component: () =>
        ...
        children: [{
                path: 'index',
                component: () =>
                    import ('@/views/jiangqi/list'),
                name: 'room',
                meta: { title: '开奖设置', icon: 'dashboard', roles: ['admin', 'yunying'] }
            },
    ...
    },
    {
        ...
        children: [{
                path: 'userlist',
                component: () =>
                    import ('@/views/user/list_time'),
                name: 'userlist',
                meta: { title: '用户列表', icon: 'dashboard', roles: ['admin', 'yunying'] }
            }
...

    {
        ...
        children: [{
                path: 'order',
                component: () =>
                    import ('@/views/order/list_time'),
                name: 'order',
                meta: { title: '投注记录', icon: 'dashboard', roles: ['admin','yunying'] }
            }
